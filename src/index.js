            ...
            <BrowserRouter basename={'/'}>
                <PageScrollTop>
                    <Switch>
                        ...
                        <Route exact path={`${process.env.PUBLIC_URL}/service-details2`} component={ServiceDetails2}/>
                        <Route exact path={`${process.env.PUBLIC_URL}/service-details3`} component={ServiceDetails3}/>
